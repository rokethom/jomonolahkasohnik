...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'preferred_vehicle_type' => ['nullable', 'string', 'in:motor,mobil'],
            'vehicle_seat_rows' => ['nullable', 'integer', 'in:2,3'],
            'driver_preference' => ['nullable', 'string', 'in:general,ladies'],
            'live_price_review_token' => ['nullable', 'uuid'],
            'destination_text' => ['nullable', 'string', 'max:255'],
            'service_payload' => ['sometimes', 'array'],
            'service_payload.preferred_vehicle_type' => ['nullable', 'string', 'in:motor,mobil'],
            'service_payload.vehicle_seat_rows' => ['nullable', 'integer', 'in:2,3'],
            'service_payload.driver_preference' => ['nullable', 'string', 'in:general,ladies'],
            'service_payload.live_price_review_token' => ['nullable', 'uuid'],

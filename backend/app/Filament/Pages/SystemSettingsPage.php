...
class SystemSettingsPage extends Page implements HasForms
{
                        ...
                        Tabs\Tab::make('Operasional Order')
                            ...
                            ->schema([
                                ...
                                Forms\Components\Section::make('Zone Pricing Customer')
                                    ->description('Atur apakah rule zona aktif ikut menghitung tarif customer.')
                                    ->schema([
                                        Forms\Components\Toggle::make('zone_pricing_enabled')
                                            ->label('Aktifkan zone pricing untuk order customer')
                                            ->helperText('Jika nonaktif, menu Zone Pricing dan tester tetap bisa dipakai, tetapi kalkulasi customer tidak memakai rule zona.'),
                                    ]),
    ...
    public function save(SettingService $settings): void
    {
        ...
        $settings->set('zone_pricing_enabled', (bool) ($data['zone_pricing_enabled'] ?? true));

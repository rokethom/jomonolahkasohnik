...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('admin')->middleware('role:admin,gm,hrd,manager,spv,operator,eksekutor,web_admin,cms_editor')->group(function () {
        ...
        Route::post('/drivers/{driver}/deposit/paid', [AdminController::class, 'markDriverDepositPaid']);
        Route::post('/drivers/{driver}/deposit/unpaid', [AdminController::class, 'markDriverDepositUnpaid']);
        ...
        Route::put('/drivers/{driver}/config', [AdminController::class, 'updateDriverConfig']);
        ...
        Route::post('/ring-pricing-suggestions/learn-request-orders', [AdminController::class, 'learnRingPricingFromRequestOrders'])->middleware('permission:edit_tarif');

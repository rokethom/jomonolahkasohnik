...
<div class="space-y-3">
    ...
    @if ($googleMapsKey)
        <div
            id="{{ $mapId }}"
            style="height: 360px; border-radius: 8px; overflow: hidden; border: 1px solid rgba(148, 163, 184, .35); display: grid; place-items: center; color: rgb(148, 163, 184); background: rgba(15, 23, 42, .22);"
        >
            Memuat Google Maps...
        </div>
    @else
